...
'''
input: 256 day change%
output: change% in 10 class
'''
...
# Network Parameters
n_input = 6 # MNIST data input (img shape: 2*128)
n_steps = 128 # timesteps
n_hidden = 128 # hidden layer num of features
n_classes = 4 # MNIST total classes (0-4 digits)
...
with tf.Session() as sess:
    ...
    while step * batch_size < training_iters:
        batch_x, batch_y = reader.training_next_batch(batch_size)
